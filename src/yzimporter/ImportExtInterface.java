...
public class ImportExtInterface extends JFrame implements Runnable{
    ...
    public int error = 0;
    public int filestreated = 0;
    public int fileserror = 0;
    
    public ImportExtInterface(GraphicMainInterface parent) {
	...
	setSize(552,350);
	setTitle("Import des billets externes en cours...");
	...
	JOptionPane.showMessageDialog(this,
	"Les fichiers externes ont été traités. \n \nFichiers traiés : "+filestreated+" - fichiers en erreur : "+fileserror+"\n \nBillets ajoutés : "+added+"\nBillets mise à jour : "+updated+"\nErreurs de traitement : "+error,
